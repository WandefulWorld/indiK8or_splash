    ...
    return ( 
        <div className="bg-gradient-to-b from-gray-400 bg-black flex items-center flex-col">
            <div className="space-y-24 flex-column  justify-center items-center">
                <h1 className="pt-36 text-gray-100 font-semibold font-serif text-3xl text-center">Simplify and Visualize Your Kubernetes Environment Today</h1>
                <p className='max-w-7xl bg-gray-400 rounded-xl shadow border p-8 m-10 text-gray-900 text-center text-lg font-serif pl-28 pr-28 font-serif'>
