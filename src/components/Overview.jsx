    ...
    return ( 
        <div className="bg-gradient-to-b from-gray-400 bg-black flex items-center flex-col">
            ...
            <div className="space-y-24 flex-column  justify-center items-center">
                <h1 className="pt-24 text-gray-100 font-semibold font-serif text-4xl text-center">Simplify and Visualize Your Kubernetes Environment Today</h1>
                <p className='max-w-6xl bg-gray-200 opacity-70 rounded-xl shadow-md border p-8 m-10 text-gray-900 text-start text-2xl font-serif pl-12 pr-12'> 
