  ...
  return (
    <div className='bg-white font-serif '>
      <div className="mx-auto grid max-w-2xl grid-cols-1 items-center gap-x-8 gap-y-16 px-4 py-24 sm:px-6 sm:py-32 lg:max-w-7xl lg:grid-cols-1 lg:px-8">
            ...
            {images1.map((product) => (
              <div key={product.id} className="group relative">
                  <img
                    ...
                    className="h-full w-full object-fill object-center lg:h-full lg:w-full rounded-lg"
                  />
              </div>  
            ))}
        ...
        {/* <div className="mt-8 grid grid-cols-2 gap-x-4 gap-y-10 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
          {images.map((product) => (
            <div key={product.id} className="group relative">
                <img
                  src={product.imageSrc}
